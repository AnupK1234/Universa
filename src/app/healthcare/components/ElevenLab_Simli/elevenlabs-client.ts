...
class WebSocketHandler {
    static async create(config) {
        ...
        try {
            ...
            console.log("CONFIGGGGG FROM CREATE : ", config)
        ...
        //         webSocket?.send(JSON.stringify(overridesEvent));
        //       },
        //       { once: true }
        //     );
        ...
        //   } = conversationConfig;
            ...
            const metadata = await this.waitForMetadata(webSocket, config);
    ...
    static async waitForMetadata(webSocket, config) {
